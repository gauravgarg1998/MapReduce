...
class household_language extends JInternalFrame implements ActionListener
{
private	JPanel		topPanel;
	...
	String unit;
	public household_language(JFrame parent)
	{
		super("household_language",true,true);

		unit="household_language";
		...
		cmdVwPat=new JButton("Show household_language");
...
FileSystem fs = FileSystem.get(conf);
 ...
 line=br.readLine();
    ...
    Object columnNames[] = { "Marital Status", "Numebrs" };
 ...
 while(line!=null)
 {
	 System.out.println(line + "....");
	  ...
	  for (String val: line.split("\t"))
	  {
		  if(j==0)
		  {
			  rowData[i][j++]=new definition().get_household_language(Integer.parseInt(val));
		  }
		  else
		  rowData[i][j++]=val;
