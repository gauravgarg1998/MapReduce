...
class FrameMain extends JFrame implements ActionListener
{
	...
	JMenuBar jb;
	JMenuItem ut1,ut2,ut3,ut4,ut5,ut6,ut7,ut8,ut9,ut10,ut11,ut12;
	...
	public FrameMain()
	{
		...
		ut8=new JMenuItem("Avg Income of Worker class");
				ut11=new JMenuItem("Marital Status");
ut12=new JMenuItem("Household Language");
		...
		ut11.addActionListener(this);
				ut12.addActionListener(this);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource()==ut11)
		{
			marital_status u1=new marital_status(this);
			dsk.add(u1);
		}
			if(ae.getSource()==ut12)
		{
			household_language u1=new household_language(this);
			dsk.add(u1);
		}
