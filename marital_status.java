...
class marital_status extends JInternalFrame implements ActionListener
{
private	JPanel		topPanel;
	...
	String unit;
	public marital_status(JFrame parent)
	{
		super("marital_status",true,true);
		...
		cmdVwPat=new JButton("Show marital_status");
 ...
 while(line!=null)
 {
	 System.out.println(line + "....");
	  ...
	  for (String val: line.split("\t"))
	  {
		  if(j==0)
		  {
			  rowData[i][j++]=new definition().get_marital_status(Integer.parseInt(val));
		  }
		  else
		  rowData[i][j++]=val;
